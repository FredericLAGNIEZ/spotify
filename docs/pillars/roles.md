...
Spotify's data organization follows a Center of Excellence (CoE) model — a hybrid between centralized and embedded structures. A central data team holds expertise and best practices while working closely with representatives embedded in each department, improving data–business collaboration and helping prevent silos. This structure requires a unified, well-governed policy to succeed — which is the purpose of this framework.
